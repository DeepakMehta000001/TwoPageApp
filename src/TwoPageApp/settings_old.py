"""
Django settings for TwoPageApp project.
...
SECRET_KEY = 'x!zs#1a5c5e)p85vvljw+$yrp(%l5^eicmch8d45mhm75xv#r2'
...
WSGI_APPLICATION = 'TwoPageApp.wsgi.application'
